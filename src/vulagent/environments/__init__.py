"""Environment implementations for vul-agent."""
...
_ENVIRONMENT_MAPPING = {
    "docker": "vulagent.environments.docker.DockerEnvironment",
    "singularity": "vulagent.environments.singularity.SingularityEnvironment",
    "local": "vulagent.environments.local.LocalEnvironment",
    "swerex_docker": "vulagent.environments.extra.swerex_docker.SwerexDockerEnvironment",
    "bubblewrap": "vulagent.environments.extra.bubblewrap.BubblewrapEnvironment",
}
