...
def get_model_name(input_model_name: str | None = None, config: dict | None = None) -> str:
    ...
    if from_env := os.getenv("MODEL_NAME"):
        return from_env
    raise ValueError("No model set. Use --model or set MODEL_NAME env var.")


_MODEL_CLASS_MAPPING = {
    "anthropic": "revelio.models.anthropic.AnthropicModel",
    "litellm": "revelio.models.litellm_model.LitellmModel",
}
...
def get_model_class(model_name: str, model_class: str = "") -> type:
    ...
    e.g., "anthropic" or "revelio.models.anthropic.AnthropicModel"),
    ...
    from revelio.models.litellm_model import LitellmModel
