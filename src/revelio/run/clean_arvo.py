...
Usage:
    ...
    python -m revelio.run.clean_arvo --image n132/arvo:14935-vul
    
    # Clean and save as new tag
    python -m revelio.run.clean_arvo --image n132/arvo:14935-vul --output-tag my-repo/arvo:14935-clean
    
    # Just inspect what would be removed (dry run)
    python -m revelio.run.clean_arvo --image n132/arvo:14935-vul --dry-run
"""
...
def main(
    ...
    if dry_run:
        ...
        container_name = f"revelio-clean-{uuid.uuid4().hex[:8]}"
    ...
    try:
        ...
        console.print()
        console.print("Usage:")
        console.print(f"  python -m revelio.run.detect --arvo {output_tag}")
